    ...
    static async build(password, send = false, to, amount, metadata = '', fees = 0.001, key){
        ...
        if(password !== ''){
            ...
            try {
                ...
                // createrawtransaction '[{"txid":"4046e865e56c2f1e1cdc79af5cb9fdd03ec4181a914c9dbc2d44e27887114f82","vout":0}]' '{"RNDGt6v4mhH6enmUfvzu1oWYtn9AbtdujX":0.01,"RViEPexN8ZMjnKr5F4mvGHD5AM7qcic1Yd":0.1899}' 0 1626530
                
                // signrawtransaction  '[{"txid":"4046e865e56c2f1e1cdc79af5cb9fdd03ec4181a914c9dbc2d44e27887114f82","vout":0,"scriptPubKey":"76a914e01ed865affaa8eee850451815cba6b2f4ba291188ac","amount":0.2}]' '["Uvp5PxBQgLW6D1TZF44rZ5YfGRTTHYnASEp9NaRNcdDE1xdJuE1s"]'
                
                // sendrawtransaction 
